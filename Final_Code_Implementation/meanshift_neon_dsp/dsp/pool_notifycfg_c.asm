...
;* Date/Time created: Fri Jun  9 07:51:33 2017                                *
;******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	...
	.dwattr $C$DW$CU, DW_AT_comp_dir("/data/home/in4342-06/assignment02/carlo/meanshift_neon_dsp/dsp")
;	/data/bbToolChain/usr/local/share/c6000/bin/opt6x /tmp/08737uoLbYC /tmp/08737iI0dBy 
